...
[Previous](https://magicui.design/docs/story) [Next](https://magicui.design/docs/components/android)

Here you can find all the components available in the library.

[Android](https://magicui.design/docs/components/android) [Animated Beam](https://magicui.design/docs/components/animated-beam) [Animated Circular Progress Bar](https://magicui.design/docs/components/animated-circular-progress-bar) [Animated Gradient Text](https://magicui.design/docs/components/animated-gradient-text) [Animated Grid Pattern](https://magicui.design/docs/components/animated-grid-pattern) [Animated List](https://magicui.design/docs/components/animated-list) [Animated Shiny Text](https://magicui.design/docs/components/animated-shiny-text) [Theme Toggler](https://magicui.design/docs/components/animated-theme-toggler) [Aurora Text](https://magicui.design/docs/components/aurora-text) [Avatar Circles](https://magicui.design/docs/components/avatar-circles) [Bento Grid](https://magicui.design/docs/components/bento-grid) [Blur Fade](https://magicui.design/docs/components/blur-fade) [Border Beam](https://magicui.design/docs/components/border-beam) [Code Comparison](https://magicui.design/docs/components/code-comparison) [Comic Text](https://magicui.design/docs/components/comic-text) [Confetti](https://magicui.design/docs/components/confetti) [Cool Mode](https://magicui.design/docs/components/cool-mode) [Dock](https://magicui.design/docs/components/dock) [Dot Pattern](https://magicui.design/docs/components/dot-pattern) [Dotted Map](https://magicui.design/docs/components/dotted-map) [File Tree](https://magicui.design/docs/components/file-tree) [Flickering Grid](https://magicui.design/docs/components/flickering-grid) [Globe](https://magicui.design/docs/components/globe) [Grid Pattern](https://magicui.design/docs/components/grid-pattern) [Hero Video Dialog](https://magicui.design/docs/components/hero-video-dialog) [Text Highlighter](https://magicui.design/docs/components/highlighter) [Hyper Text](https://magicui.design/docs/components/hyper-text) [Icon Cloud](https://magicui.design/docs/components/icon-cloud) [Interactive Grid Pattern](https://magicui.design/docs/components/interactive-grid-pattern) [Interactive Hover Button](https://magicui.design/docs/components/interactive-hover-button) [iPhone](https://magicui.design/docs/components/iphone) [Lens](https://magicui.design/docs/components/lens) [Light Rays](https://magicui.design/docs/components/light-rays) [Line Shadow Text](https://magicui.design/docs/components/line-shadow-text) [Magic Card](https://magicui.design/docs/components/magic-card) [Marquee](https://magicui.design/docs/components/marquee) [Meteors](https://magicui.design/docs/components/meteors) [Morphing Text](https://magicui.design/docs/components/morphing-text) [Neon Gradient Card](https://magicui.design/docs/components/neon-gradient-card) [Number Ticker](https://magicui.design/docs/components/number-ticker) [Orbiting Circles](https://magicui.design/docs/components/orbiting-circles) [Particles](https://magicui.design/docs/components/particles) [Pixel Image](https://magicui.design/docs/components/pixel-image) [Pointer](https://magicui.design/docs/components/pointer) [Progressive Blur](https://magicui.design/docs/components/progressive-blur) [Pulsating Button](https://magicui.design/docs/components/pulsating-button) [Rainbow Button](https://magicui.design/docs/components/rainbow-button) [Retro Grid](https://magicui.design/docs/components/retro-grid) [Ripple Button](https://magicui.design/docs/components/ripple-button) [Ripple](https://magicui.design/docs/components/ripple) [Safari](https://magicui.design/docs/components/safari) [Scroll Based Velocity](https://magicui.design/docs/components/scroll-based-velocity) [Scroll Progress](https://magicui.design/docs/components/scroll-progress) [Shimmer Button](https://magicui.design/docs/components/shimmer-button) [Shine Border](https://magicui.design/docs/components/shine-border) [Shiny Button](https://magicui.design/docs/components/shiny-button) [Smooth Cursor](https://magicui.design/docs/components/smooth-cursor) [Sparkles Text](https://magicui.design/docs/components/sparkles-text) [Spinning Text](https://magicui.design/docs/components/spinning-text) [Striped Pattern](https://magicui.design/docs/components/striped-pattern) [Terminal](https://magicui.design/docs/components/terminal) [Text Animate](https://magicui.design/docs/components/text-animate) [Text Reveal](https://magicui.design/docs/components/text-reveal) [Tweet Card](https://magicui.design/docs/components/tweet-card) [Typing Animation](https://magicui.design/docs/components/typing-animation) [Video Text](https://magicui.design/docs/components/video-text) [Warp Background](https://magicui.design/docs/components/warp-background) [Word Rotate](https://magicui.design/docs/components/word-rotate)

[Story](https://magicui.design/docs/story) [Android](https://magicui.design/docs/components/android)