...
[Previous](https://magicui.design/docs/components) [Next](https://magicui.design/docs/components/animated-beam)

A mockup of an Android device.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/android-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/android-demo-2.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/android-demo-3.json)
...
```
Copyimport { Android } from "@/components/ui/android"
```
...
[Components](https://magicui.design/docs/components) [Animated Beam](https://magicui.design/docs/components/animated-beam)

On This Page

[Installation](https://magicui.design/docs/components/android#installation) [Examples](https://magicui.design/docs/components/android#examples) [With Image](https://magicui.design/docs/components/android#with-image) [With Video](https://magicui.design/docs/components/android#with-video) [Usage](https://magicui.design/docs/components/android#usage) [Props](https://magicui.design/docs/components/android#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fandroid&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fandroid&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/android.mdx)
