...
[Previous](https://magicui.design/docs/components/animated-beam) [Next](https://magicui.design/docs/components/animated-gradient-text)

Animated Circular Progress Bar is a component that displays a circular gauge with a percentage value.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/animated-circular-progress-bar-demo.json)
...
```
Copyimport { AnimatedCircularProgressBar } from "@/components/ui/animated-circular-progress-bar"
```

```
Copy<AnimatedCircularProgressBar />
```
...
[Animated Beam](https://magicui.design/docs/components/animated-beam) [Animated Gradient Text](https://magicui.design/docs/components/animated-gradient-text)

On This Page

[Installation](https://magicui.design/docs/components/animated-circular-progress-bar#installation) [Usage](https://magicui.design/docs/components/animated-circular-progress-bar#usage) [Props](https://magicui.design/docs/components/animated-circular-progress-bar#props) [Credits](https://magicui.design/docs/components/animated-circular-progress-bar#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fanimated-circular-progress-bar&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fanimated-circular-progress-bar&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/animated-circular-progress-bar.mdx)
