...
[Previous](https://magicui.design/docs/components/animated-circular-progress-bar) [Next](https://magicui.design/docs/components/animated-grid-pattern)

An animated gradient background which transitions between colors for text.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/animated-gradient-text-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/animated-gradient-text-demo-2.json)
...
```
Copyimport { AnimatedGradientText } from "@/components/ui/animated-gradient-text"
```

```
Copy<AnimatedGradientText>Animated Gradient Text</AnimatedGradientText>
```
...
[Animated Circular Progress Bar](https://magicui.design/docs/components/animated-circular-progress-bar) [Animated Grid Pattern](https://magicui.design/docs/components/animated-grid-pattern)

On This Page

[Installation](https://magicui.design/docs/components/animated-gradient-text#installation) [Examples](https://magicui.design/docs/components/animated-gradient-text#examples) [Custom Speed](https://magicui.design/docs/components/animated-gradient-text#custom-speed) [Usage](https://magicui.design/docs/components/animated-gradient-text#usage) [Props](https://magicui.design/docs/components/animated-gradient-text#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fanimated-gradient-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fanimated-gradient-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/animated-gradient-text.mdx)
