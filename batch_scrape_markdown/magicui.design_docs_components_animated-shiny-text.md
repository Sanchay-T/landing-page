...
[Previous](https://magicui.design/docs/components/animated-list) [Next](https://magicui.design/docs/components/animated-theme-toggler)

A light glare effect which pans across text making it appear as if it is shimmering.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/animated-shiny-text-demo.json)
...
```
Copyimport { AnimatedShinyText } from "@/components/ui/animated-shiny-text"
```

```
Copy<AnimatedShinyText>Hello</AnimatedShinyText>
```
...
[Animated List](https://magicui.design/docs/components/animated-list) [Theme Toggler](https://magicui.design/docs/components/animated-theme-toggler)

On This Page

[Installation](https://magicui.design/docs/components/animated-shiny-text#installation) [Usage](https://magicui.design/docs/components/animated-shiny-text#usage) [Props](https://magicui.design/docs/components/animated-shiny-text#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fanimated-shiny-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fanimated-shiny-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/animated-shiny-text.mdx)
