...
[Previous](https://magicui.design/docs/components/animated-shiny-text) [Next](https://magicui.design/docs/components/aurora-text)

An Animated theme toggler component, fully customizable using Tailwind CSS.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/animated-theme-toggler-demo.json)
...
```
Copyimport { AnimatedThemeToggler } from "@/components/ui/animated-theme-toggler"
```

```
Copy<AnimatedThemeToggler />
```
...
[Animated Shiny Text](https://magicui.design/docs/components/animated-shiny-text) [Aurora Text](https://magicui.design/docs/components/aurora-text)

On This Page

[Installation](https://magicui.design/docs/components/animated-theme-toggler#installation) [Usage](https://magicui.design/docs/components/animated-theme-toggler#usage) [Props](https://magicui.design/docs/components/animated-theme-toggler#props) [Credits](https://magicui.design/docs/components/animated-theme-toggler#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fanimated-theme-toggler&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fanimated-theme-toggler&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/animated-theme-toggler.mdx)
