...
[Previous](https://magicui.design/docs/components/code-comparison) [Next](https://magicui.design/docs/components/confetti)

Comic text animation that looks like a comic book text

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/comic-text-demo.json)
...
```
Copyimport { ComicText } from "@/components/ui/comic-text"
```

```
Copy<ComicText>Comic Text</ComicText>
```
...
[Code Comparison](https://magicui.design/docs/components/code-comparison) [Confetti](https://magicui.design/docs/components/confetti)

On This Page

[Installation](https://magicui.design/docs/components/comic-text#installation) [Usage](https://magicui.design/docs/components/comic-text#usage) [Props](https://magicui.design/docs/components/comic-text#props) [Credits](https://magicui.design/docs/components/comic-text#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fcomic-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fcomic-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/comic-text.mdx)
