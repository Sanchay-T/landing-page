...
[Previous](https://magicui.design/docs/components/confetti) [Next](https://magicui.design/docs/components/dock)

Cool mode effect for buttons, links, and other DOMs

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/cool-mode-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/cool-mode-custom.json)
...
```
Copyimport { CoolMode } from "@/components/ui/cool-mode"
```
...
[Confetti](https://magicui.design/docs/components/confetti) [Dock](https://magicui.design/docs/components/dock)

On This Page

[Installation](https://magicui.design/docs/components/cool-mode#installation) [Examples](https://magicui.design/docs/components/cool-mode#examples) [Custom Particle](https://magicui.design/docs/components/cool-mode#custom-particle) [Usage](https://magicui.design/docs/components/cool-mode#usage) [Props](https://magicui.design/docs/components/cool-mode#props) [Credits](https://magicui.design/docs/components/cool-mode#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fcool-mode&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fcool-mode&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/cool-mode.mdx)
