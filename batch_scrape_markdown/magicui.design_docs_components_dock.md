...
[Previous](https://magicui.design/docs/components/cool-mode) [Next](https://magicui.design/docs/components/dot-pattern)

An implementation of the MacOS dock using react + tailwindcss + framer motion

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/dock-demo.json)

Dock

[Home](https://magicui.design/docs/components/dock#)

[Blog](https://magicui.design/docs/components/dock#)

[GitHub](https://magicui.design/docs/components/dock#)

[LinkedIn](https://magicui.design/docs/components/dock#)

[X](https://magicui.design/docs/components/dock#)

[Send Email](https://magicui.design/docs/components/dock#)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/dock-demo-2.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/dock-demo-3.json)
...
```
Copyimport { Home, Search, Settings } from "lucide-react"
...
[Cool Mode](https://magicui.design/docs/components/cool-mode) [Dot Pattern](https://magicui.design/docs/components/dot-pattern)

On This Page

[Installation](https://magicui.design/docs/components/dock#installation) [Examples](https://magicui.design/docs/components/dock#examples) [Custom Direction](https://magicui.design/docs/components/dock#custom-direction) [Custom magnification](https://magicui.design/docs/components/dock#custom-magnification) [Usage](https://magicui.design/docs/components/dock#usage) [Props](https://magicui.design/docs/components/dock#props) [Dock](https://magicui.design/docs/components/dock#dock) [DockIcon](https://magicui.design/docs/components/dock#dockicon) [Credits](https://magicui.design/docs/components/dock#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fdock&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fdock&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/dock.mdx)
