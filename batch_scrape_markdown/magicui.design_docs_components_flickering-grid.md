...
[Previous](https://magicui.design/docs/components/file-tree) [Next](https://magicui.design/docs/components/globe)

A flickering grid background made with SVGs, fully customizable using Tailwind CSS.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/flickering-grid-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/flickering-grid-rounded-demo.json)
...
```
Copyimport { FlickeringGrid } from "@/components/ui/flickering-grid"
```
...
[File Tree](https://magicui.design/docs/components/file-tree) [Globe](https://magicui.design/docs/components/globe)

On This Page

[Installation](https://magicui.design/docs/components/flickering-grid#installation) [Examples](https://magicui.design/docs/components/flickering-grid#examples) [Rounded](https://magicui.design/docs/components/flickering-grid#rounded) [Usage](https://magicui.design/docs/components/flickering-grid#usage) [Props](https://magicui.design/docs/components/flickering-grid#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fflickering-grid&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fflickering-grid&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/flickering-grid.mdx)
