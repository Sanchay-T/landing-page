...
[Previous](https://magicui.design/docs/components/grid-pattern) [Next](https://magicui.design/docs/components/highlighter)

A hero video dialog component.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/hero-video-dialog-demo.json)

![Hero Video](https://startup-template-sage.vercel.app/hero-light.png)

![Hero Video](https://startup-template-sage.vercel.app/hero-dark.png)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/hero-video-dialog-demo-top-in-bottom-out.json)
...
```
Copyimport { HeroVideoDialog } from "@/components/ui/hero-video-dialog"
```

```
Copy<HeroVideoDialog
  className="block dark:hidden"
  animationStyle="from-center"
...
[Grid Pattern](https://magicui.design/docs/components/grid-pattern) [Text Highlighter](https://magicui.design/docs/components/highlighter)

On This Page

[Installation](https://magicui.design/docs/components/hero-video-dialog#installation) [Examples](https://magicui.design/docs/components/hero-video-dialog#examples) [Top-in-bottom-out](https://magicui.design/docs/components/hero-video-dialog#top-in-bottom-out) [Usage](https://magicui.design/docs/components/hero-video-dialog#usage) [Props](https://magicui.design/docs/components/hero-video-dialog#props) [Animation Styles](https://magicui.design/docs/components/hero-video-dialog#animation-styles) [Note](https://magicui.design/docs/components/hero-video-dialog#note)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fhero-video-dialog&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fhero-video-dialog&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/hero-video-dialog.mdx)
