...
[Previous](https://magicui.design/docs/components/hero-video-dialog) [Next](https://magicui.design/docs/components/hyper-text)

A text highlighter that mimics the effect of a human-drawn marker stroke.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/highlighter-demo.json)

TheMagic UI Highlightermakes importanttext stand outeffortlessly.
...
```
Copyimport { Highlighter } from "@/components/ui/highlighter"
```
...
[Hero Video Dialog](https://magicui.design/docs/components/hero-video-dialog) [Hyper Text](https://magicui.design/docs/components/hyper-text)

On This Page

[Installation](https://magicui.design/docs/components/highlighter#installation) [Usage](https://magicui.design/docs/components/highlighter#usage) [Props](https://magicui.design/docs/components/highlighter#props) [Credits](https://magicui.design/docs/components/highlighter#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fhighlighter&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fhighlighter&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/highlighter.mdx)
