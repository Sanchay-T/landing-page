...
[Previous](https://magicui.design/docs/components/highlighter) [Next](https://magicui.design/docs/components/icon-cloud)

A text animation that scrambles letters before revealing the final text.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/hyper-text-demo.json)
...
```
Copyimport { HyperText } from "@/components/ui/hyper-text"
```

```
Copy<HyperText>Hover me</HyperText>
```
...
[Text Highlighter](https://magicui.design/docs/components/highlighter) [Icon Cloud](https://magicui.design/docs/components/icon-cloud)

On This Page

[Installation](https://magicui.design/docs/components/hyper-text#installation) [Usage](https://magicui.design/docs/components/hyper-text#usage) [Props](https://magicui.design/docs/components/hyper-text#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fhyper-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fhyper-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/hyper-text.mdx)
