...
[Previous](https://magicui.design/docs/components/icon-cloud) [Next](https://magicui.design/docs/components/interactive-hover-button)

A interactive background grid pattern made with SVGs, fully customizable using Tailwind CSS.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/interactive-grid-pattern-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/interactive-grid-pattern-demo-2.json)
...
```
Copyimport { InteractiveGridPattern } from "@/components/ui/interactive-grid-pattern"
```
...
[Icon Cloud](https://magicui.design/docs/components/icon-cloud) [Interactive Hover Button](https://magicui.design/docs/components/interactive-hover-button)

On This Page

[Installation](https://magicui.design/docs/components/interactive-grid-pattern#installation) [Examples](https://magicui.design/docs/components/interactive-grid-pattern#examples) [Colorful](https://magicui.design/docs/components/interactive-grid-pattern#colorful) [Usage](https://magicui.design/docs/components/interactive-grid-pattern#usage) [Props](https://magicui.design/docs/components/interactive-grid-pattern#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Finteractive-grid-pattern&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Finteractive-grid-pattern&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/interactive-grid-pattern.mdx)
