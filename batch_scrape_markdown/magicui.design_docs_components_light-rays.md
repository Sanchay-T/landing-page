...
[Previous](https://magicui.design/docs/components/lens) [Next](https://magicui.design/docs/components/line-shadow-text)

A component with animated light rays which shine down from above.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/light-rays-demo.json)
...
```
Copyimport { LightRays } from "@/components/ui/light-rays"
```

```
Copy<div className="relative h-[400px] w-full overflow-hidden rounded-xl border">
  <LightRays />
</div>
```
...
[Lens](https://magicui.design/docs/components/lens) [Line Shadow Text](https://magicui.design/docs/components/line-shadow-text)

On This Page

[Installation](https://magicui.design/docs/components/light-rays#installation) [Usage](https://magicui.design/docs/components/light-rays#usage) [Props](https://magicui.design/docs/components/light-rays#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Flight-rays&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Flight-rays&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/light-rays.mdx)
