...
[Previous](https://magicui.design/docs/components/light-rays) [Next](https://magicui.design/docs/components/magic-card)

A text component with a moving line shadow.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/line-shadow-text-demo.json)
...
```
Copyimport { LineShadowText } from "@/components/ui/line-shadow-text"
```

```
Copy<LineShadowText>Magic UI</LineShadowText>
```
...
[Light Rays](https://magicui.design/docs/components/light-rays) [Magic Card](https://magicui.design/docs/components/magic-card)

On This Page

[Installation](https://magicui.design/docs/components/line-shadow-text#installation) [Usage](https://magicui.design/docs/components/line-shadow-text#usage) [Props](https://magicui.design/docs/components/line-shadow-text#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fline-shadow-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fline-shadow-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/line-shadow-text.mdx)
