...
[Previous](https://magicui.design/docs/components/meteors) [Next](https://magicui.design/docs/components/neon-gradient-card)

A dynamic text morphing component for Magic UI.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/morphing-text-demo.json)
...
```
Copyimport { MorphingText } from "@/components/ui/morphing-text"
```

```
Copy<MorphingText texts={["Hello", "World"]} />
```
...
[Meteors](https://magicui.design/docs/components/meteors) [Neon Gradient Card](https://magicui.design/docs/components/neon-gradient-card)

On This Page

[Installation](https://magicui.design/docs/components/morphing-text#installation) [Usage](https://magicui.design/docs/components/morphing-text#usage) [Props](https://magicui.design/docs/components/morphing-text#props) [Credits](https://magicui.design/docs/components/morphing-text#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fmorphing-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fmorphing-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/morphing-text.mdx)
