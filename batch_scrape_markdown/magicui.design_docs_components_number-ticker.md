...
[Previous](https://magicui.design/docs/components/neon-gradient-card) [Next](https://magicui.design/docs/components/orbiting-circles)

Animate numbers to count up or down to a target number

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/number-ticker-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/number-ticker-decimal-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/number-ticker-demo-2.json)
...
```
Copyimport { NumberTicker } from "@/components/ui/number-ticker"
```

```
Copy<NumberTicker value={100} />
```
...
[Neon Gradient Card](https://magicui.design/docs/components/neon-gradient-card) [Orbiting Circles](https://magicui.design/docs/components/orbiting-circles)

On This Page

[Installation](https://magicui.design/docs/components/number-ticker#installation) [Example](https://magicui.design/docs/components/number-ticker#example) [Decimal](https://magicui.design/docs/components/number-ticker#decimal) [Start Value](https://magicui.design/docs/components/number-ticker#start-value) [Usage](https://magicui.design/docs/components/number-ticker#usage) [Props](https://magicui.design/docs/components/number-ticker#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fnumber-ticker&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fnumber-ticker&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/number-ticker.mdx)
