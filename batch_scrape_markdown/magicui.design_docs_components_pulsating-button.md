...
[Previous](https://magicui.design/docs/components/progressive-blur) [Next](https://magicui.design/docs/components/rainbow-button)

An animated pulsating button useful for capturing attention of users.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/pulsating-button-demo.json)
...
```
Copyimport { PulsatingButton } from "@/components/ui/pulsating-button"
```

```
Copy<PulsatingButton>Pulsating Button</PulsatingButton>
```
...
[Progressive Blur](https://magicui.design/docs/components/progressive-blur) [Rainbow Button](https://magicui.design/docs/components/rainbow-button)

On This Page

[Installation](https://magicui.design/docs/components/pulsating-button#installation) [Usage](https://magicui.design/docs/components/pulsating-button#usage) [Props](https://magicui.design/docs/components/pulsating-button#props) [Credits](https://magicui.design/docs/components/pulsating-button#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fpulsating-button&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fpulsating-button&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/pulsating-button.mdx)
