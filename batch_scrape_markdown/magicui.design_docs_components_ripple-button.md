...
[Previous](https://magicui.design/docs/components/retro-grid) [Next](https://magicui.design/docs/components/ripple)

An animated button with ripple useful for user engagement.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/ripple-button-demo.json)
...
```
Copyimport { RippleButton } from "@/components/ui/ripple-button"
```

```
Copy<RippleButton>Ripple Button</RippleButton>
```
...
[Retro Grid](https://magicui.design/docs/components/retro-grid) [Ripple](https://magicui.design/docs/components/ripple)

On This Page

[Installation](https://magicui.design/docs/components/ripple-button#installation) [Usage](https://magicui.design/docs/components/ripple-button#usage) [Props](https://magicui.design/docs/components/ripple-button#props) [Credits](https://magicui.design/docs/components/ripple-button#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fripple-button&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fripple-button&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/ripple-button.mdx)
