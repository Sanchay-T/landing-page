...
[Previous](https://magicui.design/docs/components/ripple-button) [Next](https://magicui.design/docs/components/safari)

An animated ripple effect typically used behind elements to emphasize them.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/ripple-demo.json)
...
```
Copyimport { Ripple } from "@/components/ui/ripple"
```
...
[Ripple Button](https://magicui.design/docs/components/ripple-button) [Safari](https://magicui.design/docs/components/safari)

On This Page

[Installation](https://magicui.design/docs/components/ripple#installation) [Usage](https://magicui.design/docs/components/ripple#usage) [Props](https://magicui.design/docs/components/ripple#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fripple&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fripple&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/ripple.mdx)
