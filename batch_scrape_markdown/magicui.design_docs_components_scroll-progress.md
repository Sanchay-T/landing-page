...
[Previous](https://magicui.design/docs/components/scroll-based-velocity) [Next](https://magicui.design/docs/components/shimmer-button)

Animated Scroll Progress for your pages

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/scroll-progress-demo.json)
...
```
Copyimport { ScrollProgress } from "@/components/ui/scroll-progress"
```
...
- Credit to [dipesh\_the\_dev](https://twitter.com/dipesh_the_dev)

[Scroll Based Velocity](https://magicui.design/docs/components/scroll-based-velocity) [Shimmer Button](https://magicui.design/docs/components/shimmer-button)

On This Page

[Installation](https://magicui.design/docs/components/scroll-progress#installation) [Usage](https://magicui.design/docs/components/scroll-progress#usage) [Props](https://magicui.design/docs/components/scroll-progress#props) [Credits](https://magicui.design/docs/components/scroll-progress#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fscroll-progress&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fscroll-progress&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/scroll-progress.mdx)
