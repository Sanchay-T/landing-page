...
[Previous](https://magicui.design/docs/components/scroll-progress) [Next](https://magicui.design/docs/components/shine-border)

A button with a shimmering light which travels around the perimeter.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/shimmer-button-demo.json)
...
```
Copyimport { ShimmerButton } from "@/components/ui/shimmer-button"
```

```
Copy<ShimmerButton>Shimmer Button</ShimmerButton>
```
...
[Scroll Progress](https://magicui.design/docs/components/scroll-progress) [Shine Border](https://magicui.design/docs/components/shine-border)

On This Page

[Installation](https://magicui.design/docs/components/shimmer-button#installation) [Usage](https://magicui.design/docs/components/shimmer-button#usage) [Props](https://magicui.design/docs/components/shimmer-button#props) [Credits](https://magicui.design/docs/components/shimmer-button#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fshimmer-button&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fshimmer-button&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/shimmer-button.mdx)
