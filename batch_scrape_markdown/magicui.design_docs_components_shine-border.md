...
[Previous](https://magicui.design/docs/components/shimmer-button) [Next](https://magicui.design/docs/components/shiny-button)

Shine border is an animated background border effect.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/shine-border-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/shine-border-demo-2.json)
...
```
Copyimport { ShineBorder } from "@/registry/magicui/shine-border"
```
...
[Shimmer Button](https://magicui.design/docs/components/shimmer-button) [Shiny Button](https://magicui.design/docs/components/shiny-button)

On This Page

[Installation](https://magicui.design/docs/components/shine-border#installation) [Examples](https://magicui.design/docs/components/shine-border#examples) [Monotone](https://magicui.design/docs/components/shine-border#monotone) [Usage](https://magicui.design/docs/components/shine-border#usage) [Props](https://magicui.design/docs/components/shine-border#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fshine-border&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fshine-border&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/shine-border.mdx)
