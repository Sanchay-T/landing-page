...
[Previous](https://magicui.design/docs/components/shine-border) [Next](https://magicui.design/docs/components/smooth-cursor)

A shiny button component with dynamic styles in the dark mode or light mode.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/shiny-button-demo.json)
...
```
Copyimport { ShinyButton } from "@/components/ui/shiny-button"
```

```
Copy<ShinyButton>Shiny Button</ShinyButton>
```
...
[Shine Border](https://magicui.design/docs/components/shine-border) [Smooth Cursor](https://magicui.design/docs/components/smooth-cursor)

On This Page

[Installation](https://magicui.design/docs/components/shiny-button#installation) [Usage](https://magicui.design/docs/components/shiny-button#usage) [Props](https://magicui.design/docs/components/shiny-button#props) [Credits](https://magicui.design/docs/components/shiny-button#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fshiny-button&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fshiny-button&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/shiny-button.mdx)
