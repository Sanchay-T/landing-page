...
[Previous](https://magicui.design/docs/components/smooth-cursor) [Next](https://magicui.design/docs/components/spinning-text)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/sparkles-text-demo.json)
...
```
Copyimport { SparklesText } from "@/components/ui/sparkles-text"
```

```
Copy<SparklesText>Sparkles Text</SparklesText>
```
...
[Smooth Cursor](https://magicui.design/docs/components/smooth-cursor) [Spinning Text](https://magicui.design/docs/components/spinning-text)

On This Page

[Installation](https://magicui.design/docs/components/sparkles-text#installation) [Usage](https://magicui.design/docs/components/sparkles-text#usage) [Props](https://magicui.design/docs/components/sparkles-text#props) [Credits](https://magicui.design/docs/components/sparkles-text#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fsparkles-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fsparkles-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/sparkles-text.mdx)
