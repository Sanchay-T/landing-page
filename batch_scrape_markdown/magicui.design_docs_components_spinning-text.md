...
[Previous](https://magicui.design/docs/components/sparkles-text) [Next](https://magicui.design/docs/components/striped-pattern)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/spinning-text-demo.json)

learnmore•earnmore•growmore•learn more • earn more • grow more •
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/spinning-text-demo-2.json)
...
```
Copyimport { SpinningText } from "@/components/ui/spinning-text"
```

```
Copy<SpinningText>learn more • earn more • grow more •</SpinningText>
```
...
[Sparkles Text](https://magicui.design/docs/components/sparkles-text) [Striped Pattern](https://magicui.design/docs/components/striped-pattern)

On This Page

[Installation](https://magicui.design/docs/components/spinning-text#installation) [Examples](https://magicui.design/docs/components/spinning-text#examples) [Reverse](https://magicui.design/docs/components/spinning-text#reverse) [Usage](https://magicui.design/docs/components/spinning-text#usage) [Props](https://magicui.design/docs/components/spinning-text#props) [Credits](https://magicui.design/docs/components/spinning-text#credits)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fspinning-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fspinning-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/spinning-text.mdx)
