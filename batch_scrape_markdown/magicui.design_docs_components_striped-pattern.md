...
[Previous](https://magicui.design/docs/components/spinning-text) [Next](https://magicui.design/docs/components/terminal)

A background striped pattern made with SVGs, fully customizable using Tailwind CSS.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/striped-pattern-demo.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/striped-pattern-dashed.json)
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/striped-pattern-right.json)
...
```
Copyimport { StripedPattern } from "@/components/ui/striped-pattern"
```
...
[Spinning Text](https://magicui.design/docs/components/spinning-text) [Terminal](https://magicui.design/docs/components/terminal)

On This Page

[Installation](https://magicui.design/docs/components/striped-pattern#installation) [Examples](https://magicui.design/docs/components/striped-pattern#examples) [Striped Pattern with a dashed stroke](https://magicui.design/docs/components/striped-pattern#striped-pattern-with-a-dashed-stroke) [Striped Pattern To Right](https://magicui.design/docs/components/striped-pattern#striped-pattern-to-right) [Usage](https://magicui.design/docs/components/striped-pattern#usage) [Props](https://magicui.design/docs/components/striped-pattern#props) [StripedPattern](https://magicui.design/docs/components/striped-pattern#stripedpattern)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fstriped-pattern&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fstriped-pattern&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/striped-pattern.mdx)
