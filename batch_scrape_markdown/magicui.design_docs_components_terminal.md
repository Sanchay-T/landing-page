...
[Previous](https://magicui.design/docs/components/striped-pattern) [Next](https://magicui.design/docs/components/text-animate)

An implementation of the MacOS terminal. Useful for showcasing a command line interface.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/terminal-demo.json)

```grid gap-y-1 overflow-auto
...
[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/terminal-demo-2.json)
...
[Striped Pattern](https://magicui.design/docs/components/striped-pattern) [Text Animate](https://magicui.design/docs/components/text-animate)

On This Page

[Examples](https://magicui.design/docs/components/terminal#examples) [Custom Delays](https://magicui.design/docs/components/terminal#custom-delays) [Installation](https://magicui.design/docs/components/terminal#installation) [Usage](https://magicui.design/docs/components/terminal#usage) [Props](https://magicui.design/docs/components/terminal#props) [Terminal](https://magicui.design/docs/components/terminal#terminal) [AnimatedSpan](https://magicui.design/docs/components/terminal#animatedspan) [TypingAnimation](https://magicui.design/docs/components/terminal#typinganimation)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fterminal&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fterminal&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/terminal.mdx)
