...
[Previous](https://magicui.design/docs/components/text-animate) [Next](https://magicui.design/docs/components/tweet-card)

Fade in text as you scroll down the page.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/text-reveal-demo.json)
...
```
Copy<TextReveal>Magic UI will change the way you design.</TextReveal>
```

[Text Animate](https://magicui.design/docs/components/text-animate) [Tweet Card](https://magicui.design/docs/components/tweet-card)

On This Page

[Installation](https://magicui.design/docs/components/text-reveal#installation) [Usage](https://magicui.design/docs/components/text-reveal#usage)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Ftext-reveal&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Ftext-reveal&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/text-reveal.mdx)
