...
[Previous](https://magicui.design/docs/components/typing-animation) [Next](https://magicui.design/docs/components/warp-background)

A text component with a video background.

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/video-text-demo.json)
...
```
Copyimport { VideoText } from "@/registry/magicui/video-text"
```
...
[Typing Animation](https://magicui.design/docs/components/typing-animation) [Warp Background](https://magicui.design/docs/components/warp-background)

On This Page

[Installation](https://magicui.design/docs/components/video-text#installation) [Usage](https://magicui.design/docs/components/video-text#usage) [Props](https://magicui.design/docs/components/video-text#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fvideo-text&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fvideo-text&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/video-text.mdx)
