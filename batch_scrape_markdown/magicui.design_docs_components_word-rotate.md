...
[Previous](https://magicui.design/docs/components/warp-background) [Next](https://magicui.design/docs/installation)

A vertical rotation of words

PreviewCode

[Open in](https://v0.dev/chat/api/open?url=https://magicui.design/r/word-rotate-demo.json)
...
```
Copyimport { WordRotate } from "@/components/ui/word-rotate"
```

```
Copy<WordRotate words={["Word", "Rotate"]} />
```
...
[Warp Background](https://magicui.design/docs/components/warp-background) [Installation](https://magicui.design/docs/installation)

On This Page

[Installation](https://magicui.design/docs/components/word-rotate#installation) [Usage](https://magicui.design/docs/components/word-rotate#usage) [Props](https://magicui.design/docs/components/word-rotate#props)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Fcomponents%2Fword-rotate&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Fcomponents%2Fword-rotate&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/components/word-rotate.mdx)
