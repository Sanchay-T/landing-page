...
[Previous](https://magicui.design/docs/components/word-rotate) [Next](https://magicui.design/docs/templates/agent)
...
[Word Rotate](https://magicui.design/docs/components/word-rotate) [AI Agent Template](https://magicui.design/docs/templates/agent)

On This Page

[Create project](https://magicui.design/docs/installation#create-project) [Add components](https://magicui.design/docs/installation#add-components) [Import component](https://magicui.design/docs/installation#import-component)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Finstallation&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Finstallation&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/installation.mdx)
