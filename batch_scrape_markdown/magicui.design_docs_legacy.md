...
[Previous](https://magicui.design/docs) [Next](https://magicui.design/docs/mcp)

Documentation for older versions of Magic UI.
...
[Introduction](https://magicui.design/docs) [Magic UI MCP Server](https://magicui.design/docs/mcp)

On This Page

[Legacy Version (Tailwind v3)](https://magicui.design/docs/legacy#legacy-version-tailwind-v3) [Upgrading](https://magicui.design/docs/legacy#upgrading)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Flegacy&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Flegacy&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/legacy.mdx)
