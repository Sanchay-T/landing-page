...
[Previous](https://magicui.design/docs/installation) [Next](https://magicui.design/docs/templates/blog)

The ultimate landing page template for your AI agent startup.

[Buy Now](https://pro.magicui.design/) [Live Preview](https://agent-magicui.vercel.app/)
...
[Installation](https://magicui.design/docs/installation) [Blog Template](https://magicui.design/docs/templates/blog)

On This Page

[What is this?](https://magicui.design/docs/templates/agent#what-is-this) [Who is this for?](https://magicui.design/docs/templates/agent#who-is-this-for) [Why should I use this?](https://magicui.design/docs/templates/agent#why-should-i-use-this) [Features](https://magicui.design/docs/templates/agent#features) [Dependencies](https://magicui.design/docs/templates/agent#dependencies)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Ftemplates%2Fagent&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Ftemplates%2Fagent&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/templates/agent.mdx)
