...
[Previous](https://magicui.design/docs/templates/devtool) [Next](https://magicui.design/docs/templates/portfolio)

The ultimate landing page template for your mobile app.

[Buy Now](https://pro.magicui.design/) [Live Preview](https://mobile-magicui.vercel.app/)
...
[Dev Tool](https://magicui.design/docs/templates/devtool) [Portfolio Template](https://magicui.design/docs/templates/portfolio)

On This Page

[What is this?](https://magicui.design/docs/templates/mobile#what-is-this) [Who is this for?](https://magicui.design/docs/templates/mobile#who-is-this-for) [Why should I use this?](https://magicui.design/docs/templates/mobile#why-should-i-use-this) [Features](https://magicui.design/docs/templates/mobile#features) [Dependencies](https://magicui.design/docs/templates/mobile#dependencies)

Contribute

- [Report an issue](https://github.com/magicuidesign/magicui/issues/new?title=%5Bbug%5D%3A+%2Fdocs%2Ftemplates%2Fmobile&labels=bug&labels=documentation&template=bug_report.yml)
- [Request a feature](https://github.com/magicuidesign/magicui/issues/new?title=%5Bfeat%5D%3A+%2Fdocs%2Ftemplates%2Fmobile&labels=enhancement&template=feature_request.yml)
- [Edit this page](https://github.com/magicuidesign/magicui/edit/main/apps/www/content/docs/templates/mobile.mdx)
