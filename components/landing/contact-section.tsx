  ...
  return (
    <section id="contact" className="mx-auto mt-32 max-w-7xl px-6 md:mt-40 md:px-8">
      <div className="grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,420px)] lg:items-start">
          ...
          <ul className="space-y-3 text-sm text-white/75">
            {assurances.map((assurance) => (
              <li key={assurance} className="flex items-start gap-3">
                <span className="mt-1 flex size-7 items-center justify-center rounded-full border border-white/15 bg-[rgb(var(--brand-accent-rgb)/0.15)] text-white">
        ...
        <div className="rounded-3xl border border-white/10 bg-background/75 p-6 shadow-[0_20px_70px_-40px_rgba(15,23,42,0.9)]">
          <Form {...form}>
            <form
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Select the team we’ll collaborate with day-to-day.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>How fast do you want operators live in production?</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Select all that apply so we can prepare relevant examples.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
