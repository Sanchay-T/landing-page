...
interface ScrollVelocityRowProps extends ComponentPropsWithRef<"div"> {
  baseVelocity?: number;
  direction?: 1 | -1;
}
...
export function ScrollVelocityContainer({ children, className, ...props }: ComponentPropsWithRef<"div">) {
...
function ScrollVelocityRowImpl({
  ...
  return (
    <div ref={containerRef} className={cn("w-full overflow-hidden", className)} {...props}>
      <motion.div
