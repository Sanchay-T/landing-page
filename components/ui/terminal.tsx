...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "z-0 h-full w-full rounded-xl border border-white/10 bg-black/80",
        className,
      )}
    >
      <div className="border-border flex flex-col gap-y-2 border-b border-white/10 p-4">
      ...
      <pre className="max-h-[520px] overflow-auto p-4">
        <code className="grid gap-y-1 text-left text-sm text-white/80">
          {wrappedChildren}
        </code>
      </pre>
    </div>
