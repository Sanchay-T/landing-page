  ...
  return (
    <section className="sec">
      <div className="sec-head">
        ...
        <h2>Re-engineering, then <em>plumbing</em>. Not the other way round.</h2>
        <p className="lede">
      ...
      <div className="diagram">
        ...
        <div className="diagram-col">
          ...
          <svg className="dc-icon" viewBox="0 0 64 64" fill="none" stroke="#0e1410" strokeWidth="1.6">
            ...
            <text x="32" y="22" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="6" fill="#0e1410" letterSpacing="1">UPTIME</text>
          </svg>
  ...
  return (
    <section className="sec">
      <div className="sec-head">
        ...
        <h2>Six weeks. Four valves. <em>One named pod.</em></h2>
        <p className="lede">Same shape every time. We keep it boring on purpose — boring scales. The variation is in the diagram, not the schedule.</p>
      </div>

      <div className="process">
        <div className="proc-col">
          <span className="pn">Wk 01–02 · <b style={{ color: "var(--valve)" }}>VALVE I</b></span>
          <h3>Walk the <em>floor</em>.</h3>
          <p>Sit with the people doing the work. Watch the spreadsheets. Time the hand-offs. Map the back-channels nobody admits to. By Friday of week two we have a routing diagram and a leak ledger.</p>
        ...
        <div className="proc-col">
          <span className="pn">Wk 03–04 · <b style={{ color: "var(--valve)" }}>VALVE II</b></span>
          <h3>Build the <em>pipes</em>.</h3>
          <p>Two builders pair-ship. We default to n8n; we drop into TypeScript when n8n would be a hack; we&apos;ll happily delete an automation that didn&apos;t earn its keep. Every workflow is owned by a name, not a tool.</p>
        ...
        <div className="proc-col">
          <span className="pn">Wk 05–06 · <b style={{ color: "var(--valve)" }}>VALVE III</b></span>
          <h3>Pressure-<em>test</em>.</h3>
          <p>Live in your real environment. Devonel takes the pager. Every escalation gets logged, every false alarm gets tuned out. By the end of week six the pod has shadowed every regular hand-off twice.</p>
        ...
        <div className="proc-col">
          <span className="pn">Day 30–120 · <b style={{ color: "var(--valve)" }}>VALVE IV</b></span>
          <h3>Hand <em>over</em>.</h3>
          <p>90 days of quiet on-call, monthly tuning, a runbook your team owns. Then a clean handover — or a retainer if you want us to keep the keys. We never lock up the source. It&apos;s yours.</p>
  ...
  return (
    <section className="sec">
      <div className="sec-head">
        ...
        <h2>Twelve months. <em>Receipts.</em></h2>
        <p className="lede">A real public ledger. Hours saved, dollars recovered, and what we actually shipped — with the leak it patched.</p>
      </div>
        ...
        <aside className="proof-side">
          <div className="proof-side-top">
            ...
            <div className="stat-mini">
              <div>
                <div className="v">14<em>/14</em></div>
                <span className="k">drives shipped</span>
              </div>
              <div>
                <div className="v">162<em>hr</em></div>
                <span className="k">hr / wk freed</span>
              </div>
            </div>
            <div className="stat-mini">
              <div>
                <div className="v">9<em> ind.</em></div>
                <span className="k">industries served</span>
              </div>
              <div>
                <div className="v">11<em>wk</em></div>
                <span className="k">avg. payback</span>
              </div>
            </div>
          </div>
          <div className="quote">
            &quot;They came in expecting to install software. They left having deleted three of ours, and the right ones.&quot;
  ...
  return (
    <section className="sec">
      <div className="sec-head">
        ...
        <h2>Four things we <em>actually</em> believe.</h2>
        <p className="lede">We will not pretend to be neutral. The point of a studio is having a position.</p>
      </div>

      <div className="philo">
        <div>
          <div className="philo-num">¶</div>
          <h3>Most &quot;AI strategy&quot; is a <em>plumber problem</em>, not a model problem.</h3>
          <p><strong>The bottleneck is almost never the model.</strong> It&apos;s the spreadsheet someone keeps in a private Google folder. The handoff that goes out as a Slack DM. The CRM field nobody made required. Until those are routed, no agent will save you.</p>
          <p>We do the boring part first. We delete more code than we write. We refuse engagements where the job is to make a chatbot for a process that shouldn&apos;t exist.</p>
          <p>The output of an audit is a diagram you can argue about. If we can&apos;t draw your business in one page, we have not understood it yet, and we will not start building.</p>
        </div>
        <aside className="philo-side">
          <div className="tenet">
            <div className="t">Tenet i</div>
            <h4>No SaaS. <em>Just work, finished.</em></h4>
            <p>You hire a pod, not a license. The output is your workflow, running, owned by you. We are not building a product on the side.</p>
          </div>
          <div className="tenet">
            <div className="t">Tenet ii</div>
            <h4>Named operators, every time.</h4>
            <p>Two senior people, on the call from week one. No bait-and-switch to a junior. If the founder is not on Slack with you, something has gone wrong.</p>
          </div>
          <div className="tenet">
            <div className="t">Tenet iii</div>
            <h4>We ship the diagram <em>before</em> the build.</h4>
            <p>Week two: a routing diagram. Week three: a yes / no on the build. We will tell you when the answer is &quot;fix the process first, then call us.&quot;</p>
          </div>
          <div className="tenet">
            <div className="t">Tenet iv</div>
            <h4>The source is yours. Period.</h4>
            <p>Every workflow is in your accounts, your repos, your runbooks. We stay on retainer because you choose to, not because you can&apos;t fire us.</p>
          </div>
        </aside>
      </div>
    </section>
  ...
  return (
    <section className="contact">
      <div className="contact-grid">
        <div>
          <h2>Two intake slots,<br />Q3 <em>&apos;26</em>.</h2>
          <p>Send us a paragraph about the work that hurts most this quarter — the one that&apos;s still being done in spreadsheets at 11pm. We&apos;ll come back inside two business days with either a 90-minute walkthrough on the calendar, or a referral to someone better suited.</p>
